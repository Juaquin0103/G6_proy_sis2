...
public class registroEmpleadoTest {
    ...
    private final registroEmpleado instance = new registroEmpleado();
    
    @Test
    public void testLongitudNombre() {
        
        String nombreLargo = "Elizabeth Guadalupe";
        assertTrue(instance.validarNombre(nombreLargo), "El nombre con más de 20 caracteres debería ser aceptado");
    }

    @Test
    public void testNombreConNumeros() {
        String nombreConNumeros = "Santiago123 ";
        assertFalse(instance.validarNombre(nombreConNumeros), "El nombre con números debería ser rechazado");

        String nombreSinNumeros = "Santiago";
    ...
    public void testApellidosConNumeros() {
        String apellidoConNumeros = "Dominguez123 Rodriguez";
        assertFalse(instance.validarApellido(apellidoConNumeros), "El apellido con números debería ser rechazado");

        String apellidoSinNumeros = "Dominguez Rodriguez";
        assertTrue(instance.validarApellido(apellidoSinNumeros), "El apellido sin números debería ser aceptado");
    ...
    public void testLongitudApellido() {
        ...
        String apellidoLargo = "Dominguez Rodriguez";
        assertTrue(instance.validarNombre(apellidoLargo), "El el apellido con más de 30 caracteres debería ser aceptado");
    }
